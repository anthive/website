<template>
  <section>
    <v-parallax :src="require('@/assets/img/pre-footer.jpg')" align="" height="300" />
        ...
        >
          ...
          <v-card-text class="primary--text white-space">
            ...
            <p>
              ...
              the use of AntHive.IO's Website, located at https://anthive.io.
            </p>
            ...
            <p>
              We employ the use of cookies. By accessing anthive.io, you agreed
              to use cookies in agreement with the AntHive.IO's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, AntHive.IO and/or its licensors own the
              intellectual property rights for all material on anthive.io. All
              intellectual property rights are reserved. You may access this
              from anthive.io for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from anthive.io</li>
              <li>Sell, rent or sub-license material from anthive.io</li>
              <li>Reproduce, duplicate or copy material from anthive.io</li>
              <li>Redistribute content from anthive.io</li>
            </ul>
            ...
            <p>
              ...
              AntHive.IO does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of AntHive.IO,its agents and/or affiliates.
              ...
              laws, AntHive.IO shall not be liable for the Comments or for any
            ...
            <p>
              AntHive.IO reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant AntHive.IO a non-exclusive license to use,
            ...
            <p>
              ...
              AntHive.IO; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to AntHive.IO. Please include your name, your
            ...
            <p>
              No use of AntHive.IO's logo or other artwork will be allowed for
